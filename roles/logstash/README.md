...
| `logstash_elasticsearch_username`         | `logstash_system`       | Username used to connect to the elastisearch servers  |
| `logstash_elasticsearch_password`         | `l0gst4sHpAssw0rd,`       | password of the *logstash_elasticsearch_username*  |
